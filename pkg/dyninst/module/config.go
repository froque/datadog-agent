...
func NewConfig(_ *sysconfigtypes.Config) (*Config, error) {
	...
	c := &Config{
		...
		SymDBCacheDir:          "/var/tmp/datadog-agent/system-probe/dynamic-instrumentation/symdb-uploads",
		ProbeTombstoneFilePath: "/var/tmp/datadog-agent/system-probe/dynamic-instrumentation/debugger-probes-tombstone.json",
